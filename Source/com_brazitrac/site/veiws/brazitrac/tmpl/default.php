        ...
        <div id="cpanel">
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=announcement.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_ANNOUNCEMENTS'); ?>" src="components/com_brazitrac/assets/icons/announcement.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_ANNOUNCEMENTS'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=glossary.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_GLOSSARY'); ?>" src="components/com_brazitrac/assets/icons/glossary.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_GLOSSARY'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=faqcategories.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_FC:FAQ CATEGORIES'); ?>" src="components/com_brazitrac/assets/icons/faqcategory.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_FC:FAQ CATEGORIES'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=requestcategory.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_RC:REQUEST CATEGORIES'); ?>" src="components/com_brazitrac/assets/icons/requestcategory.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_RC:REQUEST CATEGORIES'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=request.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_R:REQUESTS'); ?>" src="components/com_brazitrac/assets/icons/request.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_R:REQUESTS'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_brazitrac&task=requestpriority.list'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_RP:REQUEST PRIORITIES'); ?>" src="components/com_brazitrac/assets/icons/requestpriority.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_RP:REQUEST PRIORITIES'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
            <div id="cpanel">
                <div style="float: left;">
                    <div class="icon">
                        <a href="">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_STATISTICS'); ?>" src="components/com_brazitrac/assets/icons/statistics.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_STATISTICS'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div style="float: left;">
                    <div class="icon">
                        <a href="<?php echo JRoute::_('index.php?option=com_plugins&view=plugins&filter_folder=brazitrac'); ?>">
                            <img alt="<?php echo JText::_('COM_BRAZITRAC_PLUGINS'); ?>" src="components/com_brazitrac/assets/icons/plugins.png"/>
                            <span><?php echo JText::_('COM_BRAZITRAC_PLUGINS'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
