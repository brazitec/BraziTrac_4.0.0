...
/**
 * Requests list view class.
 *
 * @package     Brazitrac4
 * @subpackage  Views
 */
class Brazitrac4ViewRequests extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Brazitrac4Helper::addSubmenu('requests');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BRAZITRAC4_REQUESTS_VIEW_REQUESTS_TITLE'));
		
		if ($canDo->get('core.create') || (count($user->getAuthorisedCategories('com_brazitrac4', 'core.create'))) > 0 )
		{
			JToolBarHelper::addNew('rquest.add','JTOOLBAR_NEW');
		}

		if (($canDo->get('core.edit') || $canDo->get('core.edit.own')) && isset($this->items[0]))
		{
			JToolBarHelper::editList('rquest.edit','JTOOLBAR_EDIT');
		}
